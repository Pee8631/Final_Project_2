...
// HasDepartmentHasDoctor applies the HasEdge predicate on the "department_has_doctor" edge.
func HasDepartmentHasDoctor() predicate.Department {
	return predicate.Department(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(DepartmentHasDoctorTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, DepartmentHasDoctorTable, DepartmentHasDoctorColumn),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasDepartmentHasDoctorWith applies the HasEdge predicate on the "department_has_doctor" edge with a given conditions (other predicates).
func HasDepartmentHasDoctorWith(preds ...predicate.User) predicate.Department {
	return predicate.Department(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(DepartmentHasDoctorInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, DepartmentHasDoctorTable, DepartmentHasDoctorColumn),
		)
