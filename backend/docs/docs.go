...
var doc = `{
    ...
    "paths": {
        ...
        "/chattings": {
            ...
            "post": {
                ...
                "operationId": "create-chatting",
                "parameters": [
                    {
                        "description": "Chatting entity",
                        "name": "chatting",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/chattings/{id}": {
            "get": {
                ...
                "operationId": "get-chatting",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Chatting ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
        ...
        "/scheduletimes": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/ent.ScheduleTime"
                            }
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "operationId": "create-scheduletime",
                "parameters": [
                    {
                        "description": "ScheduleTime entity",
                        "name": "scheduletime",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/scheduletimes/{id}": {
            "get": {
                ...
                "operationId": "get-scheduletime",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "ScheduleTime ID",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "operationId": "update-scheduletime",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "ScheduleTime ID",
            ...
            "delete": {
                ...
                "operationId": "delete-scheduletime",
                "parameters": [
                    {
                        "type": "integer",
                        "description": "ScheduleTime ID",
    ...
    "definitions": {
        ...
        "ent.Chatting": {
            ...
            "properties": {
                ...
                "edges": {
                    ...
                    "type": "object",
                    "$ref": "#/definitions/ent.ChattingEdges"
                },
                "id": {
                    "description": "ID of the ent.",
                    "type": "integer"
        ...
        "ent.ChattingEdges": {
            ...
            "properties": {
                "chatting_with_whom": {
                    "description": "ChattingWithWhom holds the value of the chatting_with_whom edge.",
                    "type": "object",
                    "$ref": "#/definitions/ent.User"
                },
                "whose_is_this_msg": {
                    "description": "WhoseIsThisMsg holds the value of the whose_is_this_msg edge.",
                    "type": "object",
                    "$ref": "#/definitions/ent.User"
                }
            }
        ...
        "ent.DataEdges": {
            "type": "object",
            "properties": {
                "who_is_the_owner_of_this_data": {
                    "description": "WhoIsTheOwnerOfThisData holds the value of the who_is_the_owner_of_this_data edge.",
                    "type": "object",
                    "$ref": "#/definitions/ent.User"
                }
            }
        ...
        "ent.ScheduleEdges": {
            ...
            "properties": {
                "time_schedule": {
                    "description": "TimeSchedule holds the value of the time_schedule edge.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ent.ScheduleTime"
                    }
                },
                "who_is_the_owner_of_this_schedule": {
                    "description": "WhoIsTheOwnerOfThisSchedule holds the value of the who_is_the_owner_of_this_schedule edge.",
                    "type": "object",
                    "$ref": "#/definitions/ent.User"
                }
            }
        ...
        "ent.ScheduleTime": {
            ...
            "properties": {
                "edges": {
                    ...
                    "type": "object",
                    "$ref": "#/definitions/ent.ScheduleTimeEdges"
                },
                "id": {
                    "description": "ID of the ent.",
                    "type": "integer"
                ...
                "stopTime": {
                    "description": "StopTime holds the value of the \"stopTime\" field.",
                    "type": "string"
                }
            }
        },
        "ent.ScheduleTimeEdges": {
            "type": "object",
            "properties": {
                "what_time_is_the_schedule": {
                    "description": "WhatTimeIsTheSchedule holds the value of the what_time_is_the_schedule edge.",
                    "type": "object",
                    "$ref": "#/definitions/ent.Schedule"
                }
            }
        ...
        "ent.UserEdges": {
            ...
            "properties": {
                ...
                "doctor_has_schedule": {
                    "description": "DoctorHasSchedule holds the value of the doctor_has_schedule edge.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ent.Schedule"
                    }
                ...
                "user_chatting_with_whom": {
                    "description": "UserChattingWithWhom holds the value of the user_chatting_with_whom edge.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ent.Chatting"
                    }
                ...
                "user_has_data": {
                    "description": "UserHasData holds the value of the user_has_data edge.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ent.Data"
                    }
                ...
                "who_is_owner_this_msg": {
                    "description": "WhoIsOwnerThisMsg holds the value of the who_is_owner_this_msg edge.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ent.Chatting"
                    }
