...
func init() {
	...
	_ = chatFields
	// chatDescIsLockChat is the schema descriptor for IsLockChat field.
	chatDescIsLockChat := chatFields[1].Descriptor()
	// chat.DefaultIsLockChat holds the default value on creation for the IsLockChat field.
	chat.DefaultIsLockChat = chatDescIsLockChat.Default.(bool)
