...
type DepartmentEdges struct {
	// DepartmentHasDoctor holds the value of the department_has_doctor edge.
	DepartmentHasDoctor []*User `json:"department_has_doctor,omitempty"`
	// loadedTypes holds the information for reporting if a
	// type was loaded (or requested) in eager-loading or not.
	loadedTypes [1]bool
}

// DepartmentHasDoctorOrErr returns the DepartmentHasDoctor value or an error if the edge
// was not loaded in eager-loading.
func (e DepartmentEdges) DepartmentHasDoctorOrErr() ([]*User, error) {
	if e.loadedTypes[0] {
		return e.DepartmentHasDoctor, nil
	}
	return nil, &NotLoadedError{edge: "department_has_doctor"}
}
...
func (*Department) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case department.FieldName, department.FieldImage:
...
// QueryDepartmentHasDoctor queries the "department_has_doctor" edge of the Department entity.
func (d *Department) QueryDepartmentHasDoctor() *UserQuery {
	return (&DepartmentClient{config: d.config}).QueryDepartmentHasDoctor(d)
}
