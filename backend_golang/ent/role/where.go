...
// HasRoleUser applies the HasEdge predicate on the "role_user" edge.
func HasRoleUser() predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(RoleUserTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, RoleUserTable, RoleUserPrimaryKey...),
		)
		sqlgraph.HasNeighbors(s, step)
	})
}

// HasRoleUserWith applies the HasEdge predicate on the "role_user" edge with a given conditions (other predicates).
func HasRoleUserWith(preds ...predicate.User) predicate.Role {
	return predicate.Role(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(RoleUserInverseTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, RoleUserTable, RoleUserPrimaryKey...),
		)
