...
type Client struct {
	...
	// PInfo is the client for interacting with the PInfo builders.
	PInfo *PInfoClient
...
func (c *Client) init() {
	...
	c.PInfo = NewPInfoClient(c.config)
...
// QueryAppointmentSchedule queries the appointment_schedule edge of a Appointment.
func (c *AppointmentClient) QueryAppointmentSchedule(a *Appointment) *ScheduleQuery {
...
// QueryAppointmentChat queries the appointment_chat edge of a Appointment.
func (c *AppointmentClient) QueryAppointmentChat(a *Appointment) *ChatQuery {
...
// QueryChatUser queries the chat_user edge of a Chat.
func (c *ChatClient) QueryChatUser(ch *Chat) *UserQuery {
	query := &UserQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := ch.ID
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(user.Table, user.FieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, chat.ChatUserTable, chat.ChatUserPrimaryKey...),
		)
...
// QueryChatAppointment queries the chat_appointment edge of a Chat.
func (c *ChatClient) QueryChatAppointment(ch *Chat) *AppointmentQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.O2M, false, chat.ChatAppointmentTable, chat.ChatAppointmentColumn),
		)
		fromV = sqlgraph.Neighbors(ch.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryWhatMessagesAreInThisChat queries the What_messages_are_in_this_chat edge of a Message.
func (c *MessageClient) QueryWhatMessagesAreInThisChat(m *Message) *ChatQuery {
	query := &ChatQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(chat.Table, chat.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, message.WhatMessagesAreInThisChatTable, message.WhatMessagesAreInThisChatColumn),
		)
...
// QueryWhoSendMessages queries the Who_send_messages edge of a Message.
func (c *MessageClient) QueryWhoSendMessages(m *Message) *UserQuery {
	query := &UserQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := m.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(message.Table, message.FieldID, id),
			sqlgraph.To(user.Table, user.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, message.WhoSendMessagesTable, message.WhoSendMessagesColumn),
		)
		fromV = sqlgraph.Neighbors(m.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryUserNotification queries the user_notification edge of a Notification.
func (c *NotificationClient) QueryUserNotification(n *Notification) *UserQuery {
	query := &UserQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := n.ID
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(user.Table, user.FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, notification.UserNotificationTable, notification.UserNotificationPrimaryKey...),
		)
...
// PInfoClient is a client for the PInfo schema.
type PInfoClient struct {
	config
}

// NewPInfoClient returns a client for the PInfo from the given config.
func NewPInfoClient(c config) *PInfoClient {
	return &PInfoClient{config: c}
}

// Use adds a list of mutation hooks to the hooks stack.
// A call to `Use(f, g, h)` equals to `pinfo.Hooks(f(g(h())))`.
func (c *PInfoClient) Use(hooks ...Hook) {
	c.hooks.PInfo = append(c.hooks.PInfo, hooks...)
}

// Create returns a create builder for PInfo.
func (c *PInfoClient) Create() *PInfoCreate {
	mutation := newPInfoMutation(c.config, OpCreate)
	return &PInfoCreate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// CreateBulk returns a builder for creating a bulk of PInfo entities.
func (c *PInfoClient) CreateBulk(builders ...*PInfoCreate) *PInfoCreateBulk {
	return &PInfoCreateBulk{config: c.config, builders: builders}
}

// Update returns an update builder for PInfo.
func (c *PInfoClient) Update() *PInfoUpdate {
	mutation := newPInfoMutation(c.config, OpUpdate)
	return &PInfoUpdate{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOne returns an update builder for the given entity.
func (c *PInfoClient) UpdateOne(pi *PInfo) *PInfoUpdateOne {
	mutation := newPInfoMutation(c.config, OpUpdateOne, withPInfo(pi))
	return &PInfoUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// UpdateOneID returns an update builder for the given id.
func (c *PInfoClient) UpdateOneID(id int) *PInfoUpdateOne {
	mutation := newPInfoMutation(c.config, OpUpdateOne, withPInfoID(id))
	return &PInfoUpdateOne{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// Delete returns a delete builder for PInfo.
func (c *PInfoClient) Delete() *PInfoDelete {
	mutation := newPInfoMutation(c.config, OpDelete)
	return &PInfoDelete{config: c.config, hooks: c.Hooks(), mutation: mutation}
}

// DeleteOne returns a delete builder for the given entity.
func (c *PInfoClient) DeleteOne(pi *PInfo) *PInfoDeleteOne {
	return c.DeleteOneID(pi.ID)
}

// DeleteOneID returns a delete builder for the given id.
func (c *PInfoClient) DeleteOneID(id int) *PInfoDeleteOne {
	builder := c.Delete().Where(pinfo.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
	return &PInfoDeleteOne{builder}
}

// Query returns a query builder for PInfo.
func (c *PInfoClient) Query() *PInfoQuery {
	return &PInfoQuery{
		config: c.config,
	}
}

// Get returns a PInfo entity by its id.
func (c *PInfoClient) Get(ctx context.Context, id int) (*PInfo, error) {
	return c.Query().Where(pinfo.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *PInfoClient) GetX(ctx context.Context, id int) *PInfo {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
...
// QueryWhoIsTheOwnerOfThisPInfo queries the who_is_the_owner_of_this_PInfo edge of a PInfo.
func (c *PInfoClient) QueryWhoIsTheOwnerOfThisPInfo(pi *PInfo) *UserQuery {
	query := &UserQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := pi.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(pinfo.Table, pinfo.FieldID, id),
			sqlgraph.To(user.Table, user.FieldID),
...
// Hooks returns the client hooks.
func (c *PInfoClient) Hooks() []Hook {
	return c.hooks.PInfo
}
...
// QueryScheduleAppointment queries the schedule_appointment edge of a Schedule.
func (c *ScheduleClient) QueryScheduleAppointment(s *Schedule) *AppointmentQuery {
	query := &AppointmentQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := s.ID
		step := sqlgraph.NewStep(
			...
			sqlgraph.To(appointment.Table, appointment.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, schedule.ScheduleAppointmentTable, schedule.ScheduleAppointmentColumn),
		)
...
// QueryScheduleDoctor queries the schedule_doctor edge of a Schedule.
func (c *ScheduleClient) QueryScheduleDoctor(s *Schedule) *UserQuery {
	query := &UserQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := s.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(schedule.Table, schedule.FieldID, id),
			sqlgraph.To(user.Table, user.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, schedule.ScheduleDoctorTable, schedule.ScheduleDoctorColumn),
		)
		fromV = sqlgraph.Neighbors(s.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryUserHasPInfo queries the user_has_PInfo edge of a User.
func (c *UserClient) QueryUserHasPInfo(u *User) *PInfoQuery {
	query := &PInfoQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := u.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(user.Table, user.FieldID, id),
			sqlgraph.To(pinfo.Table, pinfo.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, user.UserHasPInfoTable, user.UserHasPInfoColumn),
		)
		fromV = sqlgraph.Neighbors(u.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryDoctorSchedule queries the doctor_schedule edge of a User.
func (c *UserClient) QueryDoctorSchedule(u *User) *ScheduleQuery {
	query := &ScheduleQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := u.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(user.Table, user.FieldID, id),
			sqlgraph.To(schedule.Table, schedule.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, user.DoctorScheduleTable, user.DoctorScheduleColumn),
		)
		fromV = sqlgraph.Neighbors(u.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryUserSendMessage queries the user_send_message edge of a User.
func (c *UserClient) QueryUserSendMessage(u *User) *MessageQuery {
	query := &MessageQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := u.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(user.Table, user.FieldID, id),
			sqlgraph.To(message.Table, message.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, user.UserSendMessageTable, user.UserSendMessageColumn),
		)
		fromV = sqlgraph.Neighbors(u.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryUserSendNotification queries the user_send_notification edge of a User.
func (c *UserClient) QueryUserSendNotification(u *User) *NotificationQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2M, false, user.UserSendNotificationTable, user.UserSendNotificationPrimaryKey...),
		)
		fromV = sqlgraph.Neighbors(u.driver.Dialect(), step)
		return fromV, nil
	}
...
// QueryWhoIsInThisChat queries the who_is_in_this_chat edge of a User.
func (c *UserClient) QueryWhoIsInThisChat(u *User) *ChatQuery {
	query := &ChatQuery{config: c.config}
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := u.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(user.Table, user.FieldID, id),
			sqlgraph.To(chat.Table, chat.FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, user.WhoIsInThisChatTable, user.WhoIsInThisChatPrimaryKey...),
		)
		fromV = sqlgraph.Neighbors(u.driver.Dialect(), step)
		return fromV, nil
	}
