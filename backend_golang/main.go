...
func main() {
	...
	client, err := ent.Open("mysql", "root:@tcp(127.0.0.1:3306)/projectdbv2?parseTime=True")
	...
	controllers.NewChatController(v1, client)
	controllers.NewMessageController(v1, client)
	controllers.NewPInfoController(v1, client)
	...
	controllers.NewNotificationController(v1, client)
